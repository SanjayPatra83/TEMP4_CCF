...
# installed.
TCL_PREFIX='C:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library\include'
...
TCL_PACKAGE_PATH='C:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/hdd backup/D/python practice/TEMP4_CCF/CCFvenv\Library\lib\tclstub86.lib'
